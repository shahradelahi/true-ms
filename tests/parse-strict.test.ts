...
describe('parseStrict(string)', () => {
  ...
  it('should convert mon from Jan 2016 to ms', () => {
    expect(parseStrict('1mon', { from: new Date('2016-01-01') })).toBe(2678400000); // 31 days
  });

  it('should convert y from Jan 2016 to ms', () => {
    expect(parseStrict('1y', { from: new Date('2016-01-01') })).toBe(31622400000);
  });
...
describe('parseStrict(long string)', () => {
  ...
  it('should convert years from 2016 to ms', () => {
    expect(parseStrict('1 year', { from: new Date('2016-01-01') })).toBe(31622400000); // 356 days in 2016
  });
