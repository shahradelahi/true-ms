...
describe('ms(string)', () => {
  ...
  it('should convert mon from 2016 to ms', () => {
    // 31 days in Jan 2016
    expect(ms('1mon', { from: new Date('2016-01-01') })).toBe(2678400000);
    // 30 days in Nov 2016
    expect(ms('1mon', { from: new Date('2016-11-01') })).toBe(2592000000);
    // 31 days in Dec 2016
    expect(ms('1mon', { from: new Date('2016-12-01') })).toBe(2678400000);
  });

  it('should convert mon from 2017 to ms', () => {
    // 31 days in Jan 2017
    expect(ms('1mon', { from: new Date('2017-01-01') })).toBe(2678400000);
    // 28 days in Feb 2017
    expect(ms('1mon', { from: new Date('2017-02-01') })).toBe(2419200000);
    // 30 days in Dec 2017
    expect(ms('1mon', { from: new Date('2017-12-01') })).toBe(2678400000);
  });

  it('should convert y from Jan 2016 to ms', () => {
    expect(ms('1y', { from: new Date('2016-01-01') })).toBe(31622400000); // 366 days in 2016
  });

  it('should convert y from Jan 2017 to ms', () => {
    expect(ms('1y', { from: new Date('2017-01-01') })).toBe(31536000000); // 365 days in 2017
  });
